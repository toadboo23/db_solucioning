        ...
        <div className="space-y-6">
          ...
          {leaveType === 'it' && (
            <div>
              ...
              <RadioGroup value={itReason} onValueChange={(value: 'enfermedad' | 'accidente' | 'embarazo' | 'paternidad') => setItReason(value)}>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="paternidad" id="paternidad" />
                  <Label htmlFor="paternidad">Paternidad</Label>
                </div>
              </RadioGroup>
            </div>
          )}
